...
var intro2 = [
    ...
    "볼라뇨는 1953년 칠레에서 태어나 유년기를 보내고 멕시코로 이주해 청년기를 보냈다. 항상 스스로를 시인의로 여겼던 그는 15세부터 시를 쓰기 시작해 20대 초반에는 $lt;인프라레알리스모&gt;라는 반항적 시 문학 운동을 이끌기도 했다. 이어 20대 중반 유럽으로 이주, 30대 이후 본격적으로 소설 쓰기에 투신한다.",
